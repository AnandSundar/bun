...
const internalErrorName = $newNativeFunction("node_util_binding.rs", "internalErrorName", 1);
const parseEnv = $newNativeFunction("node_util_binding.rs", "parseEnv", 1);
...
const parseArgs = $newNativeFunction("parse_args.rs", "parseArgs", 1);
